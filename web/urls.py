...
from .views import staff_login, reviewer_entry_signup, data_entry_signup, staff_logout, home, dashboard, customer_login, create_customer, data_entry_dashbaord, review_officer_dashboard
...
urlpatterns = [
    ...
    path("review-officer/dashboard/", review_officer_dashboard, name="review-officer-dashboard"),
