...
class CustomerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            ...
            "status",
            "outstanding_balance",
            "data_entry_officer_note",
            "nextdue",
        )  # You removed approval form the list and  exitdate
        labels = {
            "no": "Customer ID",
        ...
        widgets = {
            ...
            # 'class': 'form-control'}),
            "data_entry_officer_note": forms.TextInput(
                attrs={
    ...
    other_state = forms.CharField(
        max_length=225,
        required=False,
        widget=forms.TextInput(attrs={"placeholder": "Specify state"}),
    )
    outstanding_balance = forms.IntegerField(
        required=False,
        widget=forms.NumberInput(attrs={"placeholder": "Outstanding Balance"}),
    )  # Added field
    other_business_type = forms.CharField(
        label="Specify Business",
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "id": "other_business_type"}
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["state"].choices = [("", "Select")] + list(
...
class ReviwerEditCustomerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "review_officer_note": forms.TextInput(
                attrs={
                    "placeholder": "Enter comment here...",
                    "class": "form-control",
                    "id": "text-field-id",
...
class ApproverEditCustomerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "approval_officer_note": forms.TextInput(
                attrs={
                    "placeholder": "Enter comment here...",
                    "class": "form-control",
                    "id": "text-field-id",
