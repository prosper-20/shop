...
urlpatterns = [
    ...
    path(
        "shop/rent/<str:shop_no>/reminder/",
        views.send_rent_reminder,
    ...
    path(
        "shop/edit/<str:shop_no>/",
        views.admin_edit_shop_form,
        name="admin-edit-shop-form",
    ),
    path(
        "shop/<str:shop_no>/generate-invoice/",
        views.generate_payment_advice,
        name="generate-shop-paymrnt-advice",
    ),
    path(
        "shop/<str:shop_no>/generate-invoice/old/",
        views.generate_payment_advice_old,
        name="generate-payment-advice-old",
    ),
    path(
        "shop/<str:shop_no>/generate-invoice/pdf/",
        views.generate_payment_advice_pdf,
        name="generate-shop-payment-advice-pdf",
    ),
    ...
    path(
        "receipts/<int:pk>/",
        views.edit_payment_slip,
        name="edit-uploaded-customer-payment",
    ),
    ...
    path(
        "all/uploaded-receipts/", views.receipt_list, name="list-all-uploaded-receipts"
    ),
    path(
        "all/uploaded-receipts/<int:pk>/",
        views.verify_payment_receipt,
        name="verify-payment-receipt",
    ),
    path(
        "all/uploaded-receipts/<int:pk>/review/",
        views.review_payment_receipt,
        name="review-uploaded-payment-receipts",
    ),
]
