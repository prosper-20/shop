...
class ShopForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["floor"].choices = [("", "Select")] + list(
...
class MyShopForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.type:
            self.fields["price"].initial = self.instance.TYPE_PRICES.get(
...
class PaymentSlipForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["customer"].widget = forms.Select(
            choices=[("", "Select a customer")]
            + [(c.id, f"{c.no} - {c.name}") for c in self.fields["customer"].queryset]
        )
